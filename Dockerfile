...
ENV PATH "$PATH:/home/piper/xs_cli/bin"
...
RUN cf add-plugin-repo CF-Community https://plugins.cloudfoundry.org && \
    ...
    cd .. && \
    pwd && \
    echo "export PATH=\$PATH:\$HOME/xs_cli/bin" >> ~/.bashrc && \
    echo "export PATH=\$PATH:\$HOME/xs_cli/sapjvm_8_jre/bin" >> ~/.bashrc && \
    echo "export JAVA_HOME=\$HOME/xs_cli/sapjvm_8_jre" >> ~/.bashrc && \
    echo $PATH && \
    echo $JAVA_HOME
